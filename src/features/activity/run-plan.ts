...
const TOOL_TITLES: Record<string, string> = {
  ...
  search_public_sources: "Researching public sources",
  fetch_public_url: "Reading a public web page",
  fetch_rendered_public_url: "Reading a public web page",
  cite_public_passages: "Recording public sources",
  record_market_observation: "Recording a market price",
  list_research_receipts: "Checking earlier research",
  save_working_memory: "Saving a working note",
  list_working_memory: "Checking working notes",
  create_staff: "Assigning a specialist",
  create_staff_from_definition: "Assigning a specialist",
  revise_staff: "Briefing a specialist",
  plan_staff_work: "Planning specialist work",
  execute_staff: "Starting specialist work",
  read_staff_result: "Reviewing specialist results",
  read_office_messages: "Reading office messages",
  send_staff_message: "Messaging a specialist",
  answer_staff_question: "Answering a specialist",
  execute_python_analysis: "Running a data analysis",
  execute_tool_code: "Running an analysis",
...
const CATEGORY_TITLES: Record<string, string> = {
  ...
  assignment: "Coordinating specialist work",
  waiting: "Waiting for the tender's current work",
