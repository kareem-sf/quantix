...
mod tauri_commands {
    ...
    use super::{
        ...
        SelectPricingScenarioCommand, SetupOutcome, SetupState, StartChatGptLoginError,
        StartChatGptLoginResult, StartManagerTenderCommand, StartProviderLoginCommand,
