...
def create_router(repo):
    ...
    def records(
        ...
        return service.list(
            tender_id, include_withdrawn=include_withdrawn, offset=offset, limit=limit
        )
    ...
    @router.get(
        "/tenders/{tender_id}/requirements/{requirement_id}", response_model=RequirementRecord
    )
    def get(tender_id: str, requirement_id: str):
        return service.get(tender_id, requirement_id)

    @router.post(
        "/tenders/{tender_id}/requirements/{requirement_id}/decision",
    ...
    @router.post(
        "/tenders/{tender_id}/requirements/{requirement_id}/outputs",
        response_model=RequirementRecord,
    )
    ...
    @router.post(
        "/tenders/{tender_id}/requirements/{requirement_id}/outputs/{output_id}/unlink",
        response_model=RequirementRecord,
    )
